...
Exposure.Data$Prcp24HrTrend <- case_when(
  Exposure.Data$Future.PrcpIn.CF1 & Exposure.Data$Future.PrcpIn.CF2 > Exposure.Data$Prcp.max.hist ~
...
Alt3 <- paste0("Upper plot showing an increasing trend in temperature from 1895 to 2022, and a more dramatic increase from 1970 to 2022. Lower plot showing precipitation has ", Exposure.Data$Prcp.trend, " for the entire period record.")
